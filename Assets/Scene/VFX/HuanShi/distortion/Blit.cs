...
public class Blit : ScriptableRendererFeature {
	...
	public class BlitPass : ScriptableRenderPass
	{
		...
		public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
			...
			RenderFeatureUtils.EnsureRenderTarget(ref prevColorTexture, bufferW, bufferH,
			...
			Blit(cmd, source, prevColorTexture);
			blitMaterial.SetTexture("_PrevColorTex", prevColorTexture);
			blitMaterial.SetColor("Text", Color.red);
